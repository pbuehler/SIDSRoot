...
ClassImp(OscPassiveContFact)

static OscPassiveContFact gOscPassiveContFact;

OscPassiveContFact::OscPassiveContFact()
  : FairContFact()
{
  // Constructor (called when the library is loaded)
  fName="OscPassiveContFact";
  fTitle="Factory for parameter containers in libPassive";
  setAllContainers();
  FairRuntimeDb::instance()->addContFactory(this);
}

void OscPassiveContFact::setAllContainers()
{
...
FairParSet* OscPassiveContFact::createContainer(FairContainer* c)
{
