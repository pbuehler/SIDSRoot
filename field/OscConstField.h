...
#ifndef OscConstField_H
#define OscConstField_H 1
...
class OscConstField : public FairField
{
 ...
 public:    
   ...
   **/
  OscConstField(const char* name, Double_t xMin, Double_t xMax,
		Double_t yMin, Double_t yMax, Double_t zMin,
		Double_t zMax, Double_t bX, Double_t bY, Double_t bZ);


  /** Constructor from OscFieldPar **/
  OscConstField(OscFieldPar* fieldPar);


  /** Destructor **/
  virtual ~OscConstField();
