...
OscConstField::OscConstField(const char* name, Double_t xMin, 
...
OscConstField::OscConstField(OscFieldPar* fieldPar)
  : FairField(),
    fXmin(0.),   
    fXmax(0.),
    fYmin(0.),
...
{
  if ( ! fieldPar ) {
    cerr << "-W- OscConstField::OscConstField: empty parameter container!"
	 << endl;
    fType=0;
  }
  else {
...
// -----   Set field region   ----------------------------------------------
void OscConstField::SetFieldRegion(Double_t xMin, Double_t xMax, 
...
// -----   Set field values   ----------------------------------------------
void OscConstField::SetField(Double_t bX, Double_t bY, Double_t bZ) {
  fBx   = bX;
  fBy   = bY;
  fBz   = bZ;
}
...
Double_t OscConstField::GetBx(Double_t x, Double_t y, Double_t z) {
  if ( x < fXmin  ||  x > fXmax  ||
       y < fYmin  ||  y > fYmax  ||
...
Double_t OscConstField::GetBy(Double_t x, Double_t y, Double_t z) {
  if ( x < fXmin  ||  x > fXmax  ||
       y < fYmin  ||  y > fYmax  ||
       z < fZmin  ||  z > fZmax ) return 0.;
  return fBy;
...
Double_t OscConstField::GetBz(Double_t x, Double_t y, Double_t z) {
  if ( x < fXmin  ||  x > fXmax  ||
       y < fYmin  ||  y > fYmax  ||
       z < fZmin  ||  z > fZmax ) return 0.;
  return fBz;
