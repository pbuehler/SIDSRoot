...
// ------   Constructor   --------------------------------------------------
OscFieldPar::OscFieldPar(const char* name, const char* title,
			 const char* context) 
...
// ------   Put parameters   -----------------------------------------------
void OscFieldPar::putParams(FairParamList* list) {
...
// --------   Get parameters   ---------------------------------------------
Bool_t OscFieldPar::getParams(FairParamList* list) {
...
void OscFieldPar::SetParameters(FairField* field) {

  if ( ! field ) {
    cerr << "-W- OscFieldPar::SetParameters: Empty field pointer!" << endl;
    return;
  }
  ...
  if ( fType == 0 ) {                                 // constant field
    OscConstField* fieldConst = (OscConstField*) field;
    ...
    cerr << "-W- OscFieldPar::SetParameters: Unknown field type "
	 << fType << "!" << endl;
    fBx = fBy = fBz = 0.;
