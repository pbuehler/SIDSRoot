...
// -------------------------------------------------------------------------
// -----                    OscFieldPar header file                  -----
// -----                Created 26/03/14  by M. Al-Turany              -----
// -------------------------------------------------------------------------



#ifndef OscFieldPar_H
#define OscFieldPar_H 1
...
class OscFieldPar : public FairParGenericSet
{
 ...
 public:
  ...
  OscFieldPar(const char* name, const char* title, const char* context);
...
/** default constructor  **/
 ...
 private:
  ...
  OscFieldPar(const OscFieldPar&);
  OscFieldPar& operator=(const OscFieldPar&);

  ClassDef(OscFieldPar,1);
