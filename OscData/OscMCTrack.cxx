...
OscMCTrack::OscMCTrack(Int_t pdgCode, Int_t motherId, Double_t px,
...
// -----   Copy constructor   ----------------------------------------------
OscMCTrack::OscMCTrack(const OscMCTrack& track)
  : TObject(track),
...
OscMCTrack::OscMCTrack(TParticle* part)
  : TObject(),
...
// -----   Public method Print   -------------------------------------------
void OscMCTrack::Print(Int_t trackId) const
{
...
Double_t OscMCTrack::GetMass() const
{
...
Double_t OscMCTrack::GetRapidity() const
{
...
Int_t OscMCTrack::GetNPoints(DetectorId detId) const
{
...
void OscMCTrack::SetNPoints(Int_t iDet, Int_t nPoints)
{
/*
  if ( iDet == kREF ) {
