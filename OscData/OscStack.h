 ...
 ** are copied to a OscMCTrack array, which is stored in the output.
 **
...
class OscStack : public FairGenericStack
{
  ...
  private:
    ...
    OscStack(const OscStack&);
    OscStack& operator=(const OscStack&);
